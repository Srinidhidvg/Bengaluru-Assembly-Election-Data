...
map.getView().fit([8592186.405653, 1430120.871713, 8699193.788215, 1482444.582405], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bengaluru Assembly Election Data</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (106 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Bengaluru Legislative Assembly Election Data from 2008 to 2023<br />Source: Karnataka State Election Commission';
            }
